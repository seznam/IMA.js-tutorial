      ...
      <span className={this.cssClasses('forecast-detail__precip')}>
        <span className={this.cssClasses('forecast-detail__precip__rain')}>
          <svg version="1.1" viewBox="0 0 311.566 311.566">
            <g>
              <path
                style={{ fill: '#010002' }}
                d="M136.811,30.497l-3.176,4.716C124.47,48.87,44.054,170.167,44.054,218.775
            ...
            <g>
              <g>
                <path
                  style={{ fill: '#010002' }}
                  d="M238.071,4.982l-0.963-1.441l-0.979,1.441c-2.817,4.194-27.462,41.359-27.462,56.256
              ...
              <g>
                <path
                  style={{ fill: '#010002' }}
                  d="M237.108,91.648c-16.774,0-30.426-13.641-30.426-30.41c0-15.164,23.16-50.442,27.805-57.36
        ...
        <span className={this.cssClasses('forecast-detail__precip__snow')}>
          <svg version="1.1" viewBox="0 0 362.734 362.734">
            <polygon
              points="337.78,230.856 327.939,208.815 285.174,228.974 204.972,181.356 206.899,180.222 285.174,133.761
