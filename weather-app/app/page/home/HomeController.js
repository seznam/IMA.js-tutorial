...
import CookieStorage from 'ima/storage/CookieStorage';
...
export default class HomeController extends AbstractController {
	...
	static get $dependencies() {
		return [Router, CookieStorage, ForecastService, GeoCoderService, SearchBarExtension, '$Settings.App.defaultLocation'];
	}

	constructor(router, cookieStorage, forecastService, geoCoderService, searchBarExtension, defaultLocation) {
		super();
	...
	load() {
		...
		if (location) {
			geoCoderPromise = this._geoCoderService.geoCodeMunicipality(this.params.location);
